...
public interface ActivityDao {
    ...
    void addFacilityToActivity(String activityId, String facilityId) throws SQLException;
    void removeFacilityFromActivity(String activityId, String facilityId) throws SQLException;
    ...
    void deleteActivity(String activityId) throws SQLException;

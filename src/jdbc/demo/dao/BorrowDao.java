...
public interface BorrowDao {
    ...
    void addItemToBorrow(String borrowId, String itemId) throws SQLException;
    void removeItemFromBorrow(String borrowId, String itemId) throws SQLException;
    ...
    void updateBorrow(String borrowId, int custodianId, String remarks) throws SQLException;
    void deleteBorrow(String borrowId) throws SQLException;
